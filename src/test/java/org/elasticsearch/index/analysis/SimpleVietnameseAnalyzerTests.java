...
public class SimpleVietnameseAnalyzerTests extends ESTestCase {

    public void testBasicUsage() throws Exception {
        testAnalyzer("công nghệ thông tin", "công nghệ thông tin");
        testAnalyzer("Việt Nam", "việt nam");
        testAnalyzer("công nghệ thông tin Việt Nam", "công nghệ thông tin", "việt nam");
        testAnalyzer("mua bán nhà đất", "mua bán", "nhà đất");
        testAnalyzer("nhà đất tphcm", "nhà đất", "tphcm");
    }

    private static void testAnalyzer(String source, String... expected_terms) throws IOException {
        TestAnalysis analysis = createTestAnalysis(new Index("test", "_na_"), Settings.EMPTY, new AnalysisVietnamesePlugin());
